...
--Phân hệ quản trị
	...
	GO
	--Thêm nhân viên
	--EXEC QT_THEM_NV 'bvc', N'1', N'1234567891', N'1', N'1', 1
	...
	AS 
		...
		COMMIT TRAN
	GO
	--EXEC QT_THEM_NVGH 'bvc', N'1', N'1234567891', N'1', N'1'
	...
	AS 
		BEGIN TRAN
			INSERT INTO NV_GIAOHANG(TenNVGH, CMND, DiaChi, SoDienThoai, Email) VALUES 
			(@TENNVGH ,@CMND ,@DIACHI ,	@SODIENTHOAI ,@EMAIL )
		COMMIT TRAN
	GO
	...
	AS
		BEGIN TRAN
			...
			VALUES	(@MAPDH,@MASP,@SOLUONG,@GIA)
			SELECT *
			FROM CT_PHIEUDATHANG
			WHERE MaPDH = @MAPDH
		COMMIT TRAN
	GO
	--Thêm phiếu đặt hàng
